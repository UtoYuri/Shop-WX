...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2018-01-18 17:11:07
-- 服务器版本： 5.7.19
-- PHP Version: 5.6.31
...
CREATE TABLE IF NOT EXISTS `t_record_view` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='浏览记录表';
